...
const AddVideo = () => {
  ...
  const [videoUploaded, setVideoUploaded] = useState("none");
  const [failedToUploadVideo, setFailedToUploadVideo] = useState("none");
  const UUIDv1 = v1();
  ...
  return (
    <div className="row">
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="portfolio_upload shadow-sm rounded-5">
              ...
              <p>Click here to select video or drag video here</p>
            </div>
      ...
      <div
        class="toast position-fixed bottom-0 end-0 mb10 mr20 text-bg-secondary-emphasis border-0"
        role="alert"
        style={{ display: failedToUploadVideo }}
        // style={{ display: "block" }}
      >
        <div class="d-flex">
          <div class="toast-body">
