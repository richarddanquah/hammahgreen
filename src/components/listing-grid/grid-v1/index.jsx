        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-lg-8">
              ...
              <BannerImage img="../../../assets/images/home/accra.png" />
              
              <div className="mt10 mb50">
              <Link href="#">
                  <a className="btn btn-secondary" role="button">About Accra</a>
                </Link>
                &nbsp;
                <Link href="#">
                  <a className="btn btn-danger" role="button">Some other hyperlink</a>
                </Link>
              </div>
